## Release Notes
### v1.4.0
- Добавлены связанные объекты в карточку подрядчика
- Переименовано поле "Проект" в "Договор" в Акты, Подрядчики, Доп.Соглашения
- Изменены значения в выпадающем списке "Договор" на номер договора
- Добавлен поиск в Проекты, Подрядчики, Акты, Доп.Соглашения

### v1.3.0
- Добавлены акты для подрядчиков
- Добавлены связаннеы объекты в форму проекта

### v1.2.0
- Фикс багов обновления токена. Теперь достаточно просто выйти из системы для устранения ошибки авторизации
- Рефактор Dockerfile 
- Изменен тип выпающего списка в формах ввода на список с поиском
