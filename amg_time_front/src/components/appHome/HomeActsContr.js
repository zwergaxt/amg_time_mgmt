...
import AppListActsContr from "../appList/ListActsContr";
...
const HomeActsContr = (props) => {
    ...
    if (props.search !== undefined) {
        ...
        API_URL = API_URL_I + "actscontr_gen" + "?search=" + val
    }
        ...
        <Container fluid>
            <Row xs="12">
                <Col xs={{
                    ...
                    <AppModalActsContr create={true} resetState={refetchData} newItem={true} />
                </Col>
                <Col xs={{
                    size: 'auto',
                    order: 2,
            ...
            <Row xs="2">
                <Col xs="12" className="list-content">
                    <Card shadow={false} >
                        <div>
                            <AppListActsContr data={dataSorted()} resetState={refetchData} newItem={false} />
                        </div>
                    </Card>
                </Col>
            </Row>
