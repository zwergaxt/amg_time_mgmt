...
import AppFormReports from "../appForm/FormReports";

const AppModalReports = (props) => {
            ...
            <Modal isOpen={visible} toggle={toggle} position="center" style={{ "width": "150em" }}>
                <Card
                    ...
                    <Text
                        ...
                        {props.create ? "Добавить отчет" : "Редактировать отчет"}
                    </Text>
                    <AppFormReports
...
export default AppModalReports;