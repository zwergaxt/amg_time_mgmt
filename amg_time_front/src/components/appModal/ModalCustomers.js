...
import AppFormCustomers from "../appForm/FormCustomers";

const AppModalCustomers = (props) => {
            ...
            <Modal isOpen={visible} toggle={toggle} position="center" style={{ "width": "150em" }}>
                <Card
                    ...
                    <Text
                        ...
                        {props.create ? "Добавить заказчика" : "Редактировать заказчика"}
                    </Text>
                    <AppFormCustomers
...
export default AppModalCustomers;